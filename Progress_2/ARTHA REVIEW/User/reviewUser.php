<?php 
    ...
    $getRevSql = "SELECT * FROM makanan LEFT JOIN akun ON makanan.id_akun = akun.id_akun WHERE email_akun = '$userEmail' AND status_review = '$status'";
